...
export default function PopupApp() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white text-neutral-900 overflow-hidden font-sans relative">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-8 bg-neutral-50/50 pb-28" ref={scrollRef}>
        {/* Chat Thread */}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 pt-10 bg-gradient-to-t from-white via-white/80 to-transparent pointer-events-none z-10">
        <form onSubmit={handleChat} className="relative group w-full pointer-events-auto shadow-[0_4px_24px_rgba(0,0,0,0.06)] rounded-full">
          {/* Plus Button inside left edge */}
          <button
            type="button"
            onClick={() => setIsSaveModalOpen(true)}
            className="absolute left-1 top-1/2 -translate-y-1/2 p-2 text-neutral-400 hover:text-neutral-900 hover:bg-neutral-100 transition-colors rounded-full"
          ...
          <input
            ...
            placeholder="Ask AI..."
            className="w-full bg-white/80 backdrop-blur-md border border-neutral-200 rounded-full py-3.5 pl-12 pr-12 text-[14px] focus:outline-none focus:border-neutral-300 focus:bg-white focus:shadow-md transition-all placeholder:text-neutral-400"
          />
